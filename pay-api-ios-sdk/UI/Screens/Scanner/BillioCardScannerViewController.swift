//
//  BillioCardScannerViewController.swift
//  4billioSDK
//
...
protocol BillioCardScannerViewControllerDelegate: class {
    
    func didFindCardNumber(cardNumber: String)
    
}

class BillioCardScannerViewController: BillioBaseViewController {
    
    //MARK: - Defaults
    
    private enum Defaults {
        static let imageDetectionQueueName: String = "BillioCardScannerViewController.image.handling.queue"
    }
    ...
    weak var delegate: BillioCardScannerViewControllerDelegate?
...
extension BillioCardScannerViewController: StoryboardInstantiable {
...
extension BillioCardScannerViewController: AVCaptureVideoDataOutputSampleBufferDelegate {
